            ...
            render={({ isValid, setFieldValue }) => (
              <Form className="login-form">
                ...
                <div className="form-group">
                  ...
                  <Field name="logradouro" type="text" className="form-field" />
                  <ErrorMessage
                    component="span"
                    name="logradouro"
                    className="form-error"
                ...
                <div className="form-group">
                  <label>Número</label>
                  <Field name="numero" type="text" className="form-field" />
                  <ErrorMessage
                    component="span"
                    name="numero"
                    className="form-error"
                ...
                <div className="form-group">
                  <label>Bairro</label>
                  <Field name="bairro" type="text" className="form-field" />
                  <ErrorMessage
                    component="span"
                    name="bairro"
                    className="form-error"
                ...
                <div className="form-group">
                  <label>Cidade</label>
                  <Field name="cidade" type="text" className="form-field" />
                  <ErrorMessage
                    component="span"
                    name="cidade"
                    className="form-error"
                ...
                <div className="form-group">
                  <label>Estado</label>
                  <Field name="uf" type="text" className="form-field" />
                  <ErrorMessage
                    component="span"
                    name="uf"
                    className="form-error"
